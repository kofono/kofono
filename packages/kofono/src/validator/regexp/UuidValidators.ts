...
export const uuidValidator = validatorDeclarationBuilder("uuid", _uuid());
...
export const uuidV4Validator = validatorDeclarationBuilder("uuidV4", _uuid(4));
...
export const uuidV6Validator = validatorDeclarationBuilder("uuidV6", _uuid(6));
...
export const uuidV7Validator = validatorDeclarationBuilder("uuidV7", _uuid(7));
