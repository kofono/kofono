...
export const ipv4Validator = validatorDeclarationBuilder("ipv4", _ipv4);
...
export const ipv6Validator = validatorDeclarationBuilder("ipv6", _ipv6);
...
export const cidrv4Validator = validatorDeclarationBuilder("cidrv4", _cidrv4);
...
export const cidrv6Validator = validatorDeclarationBuilder("cidrv6", _cidrv6);
